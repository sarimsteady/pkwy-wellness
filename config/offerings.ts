export const PKWY_OFFERINGS: {
    ...
    stripe_payment_link: string;
}[] = [
        {
            ...
            classes: 1,
            price_per_class: 15,
            stripe_payment_link: process.env.NODE_ENV === "production" ? "https://buy.stripe.com/cNi5kC9vfc0qc4c9eZ3AY03" : "https://buy.stripe.com/test_14A7sK6ig2kn6Nh9GA1Fe01"
        },
        {
        ...
        },
        {
            ...
            classes: 4,
            price_per_class: 30,
            stripe_payment_link: process.env.NODE_ENV === "production" ? "https://buy.stripe.com/8x228q8rbggGeckezj3AY02" : "https://buy.stripe.com/test_7sYcN45ec3or5Jd1a41Fe03"
        }
    ];
