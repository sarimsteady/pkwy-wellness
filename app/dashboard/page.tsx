        ...
        <div className={`min-h-[85vh] flex flex-col items-center justify-center px-4 py-20 bg-white ${Fonts.quicksand.className}`}>
            <div className="max-w-xl w-full">
                ...
                <div className="bg-white border border-stone-100 rounded-[2.5rem] p-4 sm:p-10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.02)] relative overflow-hidden group">
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-orange-200/50 via-orange-500/50 to-orange-200/50 scale-x-0 group-hover:scale-x-100 transition-transform duration-700 origin-left" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <Mail className="absolute left-5 top-1/2 -translate-y-1/2 size-5 text-stone-300 group-focus-within:text-orange-500 transition-colors" />
                                <input
                                    id="email"
                                    type="email"
                                    value={email}
                                    ...
                                    required
                                    className="w-full bg-stone-50 border-none rounded-2xl py-5 pl-14 pr-6 text-stone-900 placeholder:text-stone-300 focus:ring-2 focus:ring-orange-500/20 transition-all outline-none text-base"
                                />
                            </div>
                        </div>
                        ...
                        <Button
                            ...
                            className="w-full rounded-2xl py-8 bg-stone-900 hover:bg-orange-600 text-white shadow-xl shadow-stone-100 transition-all duration-300 disabled:opacity-50 disabled:hover:bg-stone-900 group/btn"
                        >
                ...
                <div className="mt-12 text-center text-sm text-stone-400 space-y-4 font-light">
                    <p>Having trouble? Contact us at <a href="mailto:hello@pkwywellness.com" className="text-stone-600 font-medium hover:text-orange-600 transition-colors">hello@pkwywellness.com</a></p>
