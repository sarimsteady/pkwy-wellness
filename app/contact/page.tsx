...
export default function ContactPage() {
  return (
    <main className={`min-h-screen bg-white ${Fonts.quicksand.className} selection:bg-orange-100 selection:text-orange-900`}>
      <GeometryDots />
      ...
      <section className="relative pt-16 px-6 overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-20">
          {/* Email Card */}
          <div className="group relative bg-white border border-stone-100 rounded-[3rem] p-10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.03)] hover:border-orange-200/50 transition-all duration-700">
            <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-orange-50/20 to-transparent -z-10" />

            <div className="space-y-8 flex flex-col h-full">
              <div className="size-16 rounded-3xl bg-stone-50 border border-stone-100 flex items-center justify-center text-stone-400 group-hover:text-orange-500 group-hover:bg-orange-50 transition-all duration-500">
              ...
              <div className="mt-auto pt-6">
                <a href={`mailto:${About.email}`} className="block">
                  <Button size="lg" className="w-full rounded-2xl py-7 bg-stone-900 hover:bg-orange-600 text-white shadow-xl shadow-stone-100 transition-all duration-300 group/btn">
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-6">
                  <a
                    ...
                    className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-stone-400 hover:text-orange-600 transition-colors duration-300"
                  >
