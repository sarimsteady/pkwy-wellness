            ...
            <div className="max-w-2xl w-full text-center space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                    <div className="bg-white border border-stone-100 rounded-3xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
                        ...
                        <p className="text-stone-500 text-sm leading-relaxed">
                            Directions: <a href={About.address.googleMaps} className="text-orange-600 font-medium">Google Maps</a>, <a href={About.address.appleMaps} className="text-orange-600 font-medium">Apple Maps</a>
                        </p>
                    </div>
                    ...
                    <div className="bg-white border border-stone-100 rounded-3xl p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
                        ...
                        <p className="text-stone-500 text-sm leading-relaxed">
                            You can manage your membership any time <Link href="/dashboard" className="text-orange-600 font-medium">here</Link> or by contacting us at {About.email}.
                        </p>
                    </div>
