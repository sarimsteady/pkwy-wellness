        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg">
            ...
            {loading ? (
              ...
              <p className="text-gray-600 text-sm">Payment details are displayed above.</p>
            )}
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg">
            ...
            <div className="space-y-3 text-sm sm:text-base">
              ...
              <div className="flex items-start gap-3">
                <div className="w-5 h-5 text-orange-500 mt-0.5 flex-shrink-0 flex items-center justify-center">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <span className="text-gray-700">
                  <strong>Important:</strong> Please complete your{" "}
                  <Link href="/waiver" className="text-orange-600 hover:text-orange-700 font-medium underline">
                    Pilates waiver & release of liability form
                  </Link>{" "}
