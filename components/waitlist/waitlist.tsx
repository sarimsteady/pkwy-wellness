...
export function WaitlistSection() {
  return (
    <section id="waitlist" className="bg-fuchsia-400/10 rounded-4xl relative overflow-hidden py-20 px-4">
      {/* Content */}
      <div className="relative max-w-4xl mx-auto text-center space-y-8">
        {/* Badge */}
        <div className="inline-flex items-center justify-center px-4 py-2 bg-fuchsia-300/30 rounded-full">
          <span className="text-sm font-semibold text-fuchsia-600 tracking-wide">
