                        ...
                        <div className="space-y-8">
                            ...
                            <div className="space-y-4">
                                <h2 className={`text-4xl md:text-5xl font-bold text-stone-900 ${Fonts.sora.className} tracking-tight leading-tight`}>
                                    Reform Pilates <br />
                                    <span className="text-stone-400">at LA Fitness</span>
                                </h2>
                                <p className={`text-lg text-stone-500 font-light leading-relaxed max-w-md ${Fonts.quicksand.className}`}>
                                    Join Samantha for a specialized Reform Pilates session held every Tuesday morning at the LA Fitness studio in Pittsburgh.
                                </p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4 group/item">
                                    ...
                                    <div>
                                        <p className="font-semibold text-stone-900 leading-none">Every Tuesday</p>
                                ...
                                <div className="flex items-center gap-4 group/item">
                                    ...
                                    <div>
                                        <p className="font-semibold text-stone-900 leading-none">LA Fitness</p>
                                        <p className="text-sm text-stone-400 mt-1">Pittsburgh, Pennsylvania</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="pt-4">
                                <a
                                    href="https://www.lafitness.com/Pages/ClassReservation.aspx?clubid=1010&Pittsburgh-Pennsylvania&svc=p#"
                                    target="_blank"
